  ...
  const productionData = useMemo(() => {
    ...
    return listToMap
      .map((item) => ({
        ...
        quantity: item.BULK_QTY ?? item.bulk_qty ?? item.quantity ?? null,
        bulkPercent: item.BULK_PERCENT ?? item.bulk_percent ?? null,
        gcas: item.GCAS ?? item.gcas ?? null,
        ph: item.pH ?? item.ph ?? null,
        viscosity: item.VISCOSITY ?? item.viscosity ?? null,
