...
export function ProfilePage() {
  const { user, isEditing, form, onFinish, toggleEdit, handleCancel } = useProfile();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          >
            ...
            <Text type="secondary" className="capitalize block mb-4">
              {user?.role || 'User'}
            </Text>
            ...
            <div className="text-left space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Text className="text-[10px] font-bold text-slate-400 block uppercase leading-none mb-1">
                    Email
                  </Text>
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                ...
                >
                  <Input
                    prefix={<FiShield className="text-slate-400" />}
                    disabled
                    className="rounded-xl!"
                  />
                </Form.Item>
          ...
          <Card className="mt-8 border-none shadow-sm overflow-hidden">
            <div className="flex items-center justify-between">
              ...
              <Button type="link" className="font-semibold text-blue-600">
                Manage
              </Button>
            </div>
          </Card>
