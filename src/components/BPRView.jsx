...
export function BPRView() {
  const columns = [
    ...
    { title: 'Last Updated', dataIndex: 'updated', key: 'updated' },
    {
      ...
      render: () => (
        <Space>
          <Button icon={<FiEdit3 />} size="small">
            Update
          </Button>
          <Button icon={<FiShare2 />} size="small">
            Share
          </Button>
        </Space>
      ),
  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <Text type="secondary">
          Manage production logs and master records based on latest plans.
        </Text>
      </header>
      ...
      <div className="p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
        <Text strong className="text-blue-800">
          Note: Creation of PO via GMP+ Tool integration is active.
        </Text>
      </div>
    </div>
  );
