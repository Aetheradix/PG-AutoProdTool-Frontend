...
import { useArchivedPlans } from '../features/kpi/hooks/useArchivedPlans';
...
export function ArchivedPlansView() {
  ...
  const columns = [
    ...
    { title: 'Status', key: 'status', render: () => <Tag color="default">ARCHIVED</Tag> },
    {
      ...
      render: () => (
        <Space>
          <Button icon={<FiEye />} size="small">
            View
          </Button>
          <Button icon={<FiDownload />} size="small">
            Export
          </Button>
        </Space>
      ),
